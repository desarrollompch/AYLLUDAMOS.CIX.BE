            ...
            <div class="card">
              <div class="card-header">
                <div class="col-md-12">
                  <div class="d-flex">
                    <div class="col-md-8">
                      <h3>Incidentes por atender</h3>
                    </div>
                    <div class="col-md-4">
                      <a href="{{ route('reportes.incidentes-por-atender.excel') }}" class="pull-right btn disenio-boton-accion">Exportar</a>
                    </div>
                  </div>
                </div>
              </div>  
                ...
                <div class="col-md-12 nopadding">
                  <div class="d-flex">
                    ...
                    <div class="col-md-5 pull-right nopadding">
                      <form action="{{ route('reportes.incidentes-por-atender') }}">
                        <div class="d-flex">
                          <div class="col-md-5">
