        ...
        <div class="col-sm-12 table-responsive">
            <table class="table table bordered">
                <thead>
                    ...
                    <paginate ref="paginator" name="nivelesCiudadanos" :list="nivelesCiudadanos" :per="10" tag="tbody">
                    <tr v-for="(nivelCiudadano, index) in paginated('nivelesCiudadanos')">
                        ...
                        <td>
                            <a :href="getEditUrl(nivelCiudadano.id)" class="icono-editar"></a>
                            <a href="#" class="icono-eliminar" v-on:click="deleteNivelCudadano(nivelCiudadano)"></a>
                        </td>
                    </tr>
                    </paginate>      
