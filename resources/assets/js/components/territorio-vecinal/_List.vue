                ...
                <tbody v-else>
                    <tr v-for="(territorioVecinal, index) in territoriosVecinales" :key="index">
                        ...
                        <td class="botones-horizontal">
                            <a :href="getEditUrl(territorioVecinal.id)" class="btn disenio-boton-accion">
                                <i class="fa fa-pencil fa-lg" aria-hidden="true"></i>Editar
                            </a>
                            <a href="#" class="btn disenio-boton-accion" v-on:click="deleteTipoPersona(territorioVecinal)">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body table-responsive">
                        <table class="table table bordered">
                            ...
                            <tr v-for="(territorioVecinal, index) in territoriosVecinalesTemp.body">
                                <td>
                                    {{index + 1}}
                                </td>
                                <td>
