    ...
    <div>
        <div class="col-sm-12 table-responsive">
            <table class="table table bordered">
                ...
                <paginate ref="paginator" name="roles" :list="roles" :per="10" tag="tbody">
                    <tr v-for="(rol, index) in paginated('roles')">
                        ...
                        <td class="botones-horizontal">
                          ...
                          <a :href="getEditUrl(rol.id)" class="icono-editar"></a>
                          ...
                          <a href="#" class="icono-eliminar" v-on:click="deleteTipoPersona(rol)"></a>
                        </td>
                    </tr>
                </paginate>                        
