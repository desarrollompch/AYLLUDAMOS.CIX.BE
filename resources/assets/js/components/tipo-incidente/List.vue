        ...
        <div class="col-sm-12 table-responsive">
            <table class="table table bordered">
                <thead>
                    ...
                    <paginate ref="paginator" name="tipoIncidente" :list="tiposIncidentes" :per="10" tag="tbody">
                    <tr v-for="(tipoIncidente, index) in paginated('tipoIncidente')">
                        ...
                        <td class="botones-horizontal">
                            <a :href="getEditUrl(tipoIncidente.id)" class="icono-editar"></a>
                            <a href="#" class="icono-eliminar" v-on:click="deleteTipoIncidente(tipoIncidente)"></a>
                        </td>
                    </tr>
                </paginate>
