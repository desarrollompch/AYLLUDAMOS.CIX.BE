        ...
        <div class="col-sm-12 table-responsive">
            <table class="table table bordered">
                <thead>
                  ...
                  <paginate ref="paginator" name="nacionalidad" :list="nacionalidades" :per="10" tag="tbody">
                    <tr v-if="nacionalidades.length == 0">
                        <td colspan="4">No existen nacionalidades</td>
                    </tr>
                    <tr v-for="(nacionalidad, index) in paginated('nacionalidad')">
                        ...
                        <td class="botones-horizontal">
                            <a :href="getEditUrl(nacionalidad.id)" class="icono-editar"></a>
                            <a href="#" class="icono-eliminar" v-on:click="deleteTipoPersona(nacionalidad)"></a>
                        </td>
                    </tr>
                  </paginate>                        
