  ...
  <div>
    ...
    <div v-if="users" class="col-sm-12 table-responsive">
        ...
        <table class="table table bordered">
            ...
            <paginate ref="paginator" name="usuarios" :list="users" :per="10" tag="tbody">
              <tr v-for="(user, index) in paginated('usuarios')">
                ...
                <td>
                    ...
                    <a href="#" class="icono-bloquear" v-on:click="blockUser(user)" v-if="user.state == 'Activo'"></a>
                </td>
                <td>
