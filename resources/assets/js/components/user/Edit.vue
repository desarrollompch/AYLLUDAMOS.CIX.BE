    ...
    export default {
        ...
        methods: {
            editTipoUser(){
                ...
                (this.user.last_name == '') ? this.user.last_name = this.user.persona.ape_materno + ' ' + this.user.persona.ape_paterno : this.user.last_name = this.user.last_name;
                (this.user.name == '') ? this.user.name = this.user.persona.nombres : this.user.name = this.user.name;
