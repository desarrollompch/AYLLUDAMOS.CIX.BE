        ...
        <div class="col-sm-12 table-responsive">
            <table class="table table bordered">
                <thead>
                    ...
                    <paginate ref="paginator" name="configuracion" :list="configuracions" :per="10" tag="tbody">
                    <tr v-for="(configuracion, index) in paginated('configuracion')">
                        ...
                        <td>
                            <a :href="getEdiUrl(configuracion.id)" class="icono-editar"></a>
                            <a href="#" class="icono-eliminar" v-on:click="deleteDirectorio(configuracion)"></a>
                        </td>
                    </tr>
                    </paginate> 
