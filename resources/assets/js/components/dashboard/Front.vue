<template>
    <div>
        <div class="col-md-12 mb-15">
            <div style="text-align: center" class="col-md-6 offset-md-3" >
                <h4 class="card-header">Métrica general<br>Incidentes confirmados vs atendidos</h4>
        ...
        <!--<div class="col-md-12 mb-15">
            <div class="d-flex">
                <div class="col-md-6">
                    <h4 class="card-header">Tipos de usuario registrados</h4>
        ...
        <div class="col-md-12 mb-15">
            <div class="d-flex">
                <div class="col-md-6">
                    <h4 class="card-header">Usuarios registrados por tipo</h4>
                    <canvas id="users-chart-pie"></canvas>
                </div>
                <div class="col-md-6">
                    <h4 class="card-header">Incidentes registrados por estado</h4>
...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.get(route("reportes.metrica-general")).then((response) => {
                //console.log("response métricas general ", response);
